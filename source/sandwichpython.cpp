...
ZayWidget* SandWichPython::ValidWidget(sint32 postidx)
{
    if(mWidget) return mWidget;
    ...
    if(0 < Title.Length())
    {
        ...
        mWidget->Init(String::Format("python_%d", postidx), nullptr,
        ...
        mWidget->Reload(String::Format("python_%d/data/widget/%s.zay", postidx, (chars) Title));
    }
    return mWidget;
}
